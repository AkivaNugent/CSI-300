...
delete from salespersoncontact where employee_id >0;
delete from address where address_id >0;
delete from salesperson where employee_id>0;
delete from company where vendor_id>0;
...
insert into address values(1, "45 East West Street","Manchester","NH","02335",1); -- added FK for company_id
insert into address values(2, "1 Main Street", "Burlington","VT", "05401",2);
insert into address values(3, "786 Widets Lane","Hershey","PA", "25874",3);
...
insert into salespersoncontact values(4,22,'ejones@speedster.com'); -- VALUES(salespersonID, id Type, contect)
